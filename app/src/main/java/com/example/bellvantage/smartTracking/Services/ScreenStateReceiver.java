...
public class ScreenStateReceiver extends BroadcastReceiver {
    ...
    private void syncDriverTrackingDetails(Context context) {
        ...
        if (cursor.getCount() == 0) {
            System.out.println( "syncDriverTrackingDetails == No data in " + TABLE_DRIVER_TRACKING );
        } else {
            try {
                ...
                System.out.println( "Error while get dbinstnce " + e.getMessage() );
            } finally {
                if (cursor != null) {
                    cursor.close();
                }
    ...
    private void syncToServer(final DriverTracking driverTracking, Context context) {
        //Get Sync Date
        DateManager dateManager = new DateManager();
        long syncDate = dateManager.todayMillsec();
            ...
            StringRequest stringRequest = new StringRequest( Request.Method.GET, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (id == 200) {
                                System.out.println( "Tracking and Sync to server at ScreenStateReceiver SYNC_TRACKING DETAILS " );
                                ...
                                System.out.println( "Tracking fail at ScreenStateReceiver SYNC_TRACKING DETAILS " );
                            }
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            System.out.println( "Tracking fail at ScreenStateReceiver SYNC_TRACKING DETAILS " + error.getMessage() );
                        }
                    } );
            MySingleton.getInstance( context ).addToRequestQueue( stringRequest );
        } else {
            System.out.println( "Tracking fail.. No network Coverage at ScreenStateReceiver SYNC_TRACKING DETAILS " );
        }
    }
